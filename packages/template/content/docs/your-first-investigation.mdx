...
* **A decision tree.** Open it from the right-side panel if you want to see Deductive’s reasoning step by step. Reading the tree is a skill of its own and is covered on [**Continuous learning**](/docs/continuous-learning) For now, just know it’s there.

If anything in the answer looks wrong, leave a one-line comment right there. That feedback feeds the training pipeline (full guide: [**Teach Deductive**](/docs/teach-deductive)).
...
<CardGroup cols={2}>
  <Card title="Continous learning" icon="git-branch" href="/docs/continuous-learning">
