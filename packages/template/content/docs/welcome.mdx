...
<figure style={{ border: '1px solid var(--border, #e5e7eb)', borderRadius: '0.75rem', overflow: 'hidden', margin: '1.5rem 0', background: 'var(--card, #fff)' }}>
  <img src="/welcome-page-image.png" alt="A Deductive investigation" style={{ width: '100%', display: 'block' }} />
  <figcaption style={{ padding: '0.75rem 1rem', fontSize: '0.875rem', color: 'var(--muted-foreground, #6b7280)', textAlign: 'center' }}>
...
<CardGroup cols={2}>
  <Card title="Your first investigation" icon="zap" href="#">
